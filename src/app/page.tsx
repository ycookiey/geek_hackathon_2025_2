        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b] text-white overflow-hidden font-[family-name:var(--font-geist-sans)]">
            ...
            <section className="py-20 px-6 relative bg-gradient-to-b from-[#0e1b30] to-[#0f172a]">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <button className="px-10 py-5 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 rounded-full text-xl font-medium transform hover:scale-105 transition-all hover:shadow-lg hover:shadow-blue-500/25">
                        今すぐ始める
                    </button>
                </div>
            </section>
