...
import { getMealTypeInfo, getDayName, getDayColor, isToday } from "../../utils";
...
export default function DayDetail({ day, onClose, showAddMealModal }: DayDetailProps) {
  return (
    <motion.div
        ...
        <div className="p-4 min-h-[400px] overflow-y-auto overflow-x-hidden">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-bold">
              ...
              {day.date.getDate()}日
              <span className={`ml-2 ${getDayColor(day.date.getDay())}`}>
                ...
                <div key={type} className="space-y-3">
                  ...
                  {mealsOfType.length > 0 ? (
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          showAddMealModal(day.date, type as any)
                        }
